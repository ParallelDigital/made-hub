...
<div class="bg-gray-800 p-6 rounded-lg shadow-lg">
    <h2 class="text-2xl font-bold text-white mb-6">Add New Coupon</h2>
    ...
    <form action="{{ route('admin.coupons.store') }}" method="POST" class="space-y-6">
        ...
        <div>
            ...
            <div class="relative">
                ...
                <input type="text" name="code" id="code" class="block w-full bg-gray-700 border-gray-600 text-white rounded-md shadow-sm focus:ring-primary focus:border-primary pl-10 py-2.5" value="{{ old('code') }}" required placeholder="e.g., SUMMER25">
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input type="number" name="value" id="value" step="0.01" class="block w-full bg-gray-700 border-gray-600 text-white rounded-md shadow-sm focus:ring-primary focus:border-primary pl-10 py-2.5" value="{{ old('value') }}" required placeholder="e.g., 10.50 or 25">
                </div>
            </div>
        </div>
        ...
        <div class="mt-8 flex justify-end space-x-4 border-t border-gray-700 pt-6">
            ...
            <button type="submit" class="bg-primary hover:bg-opacity-90 text-black px-5 py-2.5 rounded-md text-sm font-semibold transition-colors shadow-md">Add Coupon</button>
        </div>
    </form>
</div>
@endsection
