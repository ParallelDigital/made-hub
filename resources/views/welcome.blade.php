                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-14 items-start">
                    ...
                    <div class="space-y-6 sm:space-y-7 max-w-xl mx-auto lg:mx-0">
                        <div class="flex items-start gap-4">
                            <div class="flex-shrink-0 sm:w-10 sm:h-10 rounded-full bg-primary text-purple-300 flex items-center justify-center">
                                <!-- dumbbell icon -->
                        ...
                        <div class="flex items-start gap-4">
                            <div class="flex-shrink-0 w-9 h-9 sm:w-10 sm:h-10 rounded-full bg-primary text-purple-300 flex items-center justify-center">
                                <!-- crown icon -->
