                    ...
                    <div class="max-w-md w-full mx-auto lg:mx-0">
                        <div class="relative rounded-3xl border border-white/5 ring-1 ring-white/5 bg-gradient-to-br from-[#1a1527] via-[#141021] to-[#0e0a18] p-6 sm:p-8 shadow-2xl">
                            <div class="text-center">
                                ...
                                <a href="https://gym.made-reg.co.uk/purchase#memberships" class="w-full sm:w-auto bg-primary text-black px-6 sm:px-8 py-3 sm:py-4 text-base sm:text-lg font-bold rounded hover:bg-opacity-90 transition-all transform hover:scale-105 text-center">Get Signed Up</a>
