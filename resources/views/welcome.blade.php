                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-14 items-center">
                    ...
                    <div class="space-y-6 sm:space-y-7 max-w-xl mx-auto lg:mx-0">
                        <div class="flex items-start gap-4">
                            ...
                            <div>
                                <div class="font-semibold leading-tight">5 Classes Per Month</div>
                    ...
                    <div class="max-w-md w-full mx-auto lg:mx-0">
                        <div class="relative rounded-3xl border border-primary ring-1 ring-white/5 bg-gradient-to-br from-[#1a1527] via-[#141021] to-[#0e0a18] p-6 sm:p-8 shadow-2xl mt-5">
