        ...
        <div class="fixed inset-y-0 left-0 z-50 w-64 bg-gray-800 border-r border-gray-700 transform lg:transform-none lg:opacity-100 transition-transform duration-300 ease-in-out"
            ...
            <div class="flex items-center justify-center h-16 px-4 bg-gray-900 border-b border-gray-700">
                <a href="{{ url('/') }}" class="inline-flex items-center">
                    <img src="{{ asset('made-running.png') }}" alt="MADE Admin" class="h-8 w-auto" onerror="this.onerror=null;this.src='{{ asset('favicon.ico') }}';" />
            ...
            <nav class="mt-8 px-4">
                ...
                <div class="space-y-2">
                    ...
                    <a href="{{ route('admin.class-passes.index') }}"
                       class="flex items-center px-4 py-3 text-sm font-medium rounded-lg transition-colors duration-200 {{ request()->routeIs('admin.class-passes.*') ? 'bg-primary text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white' }}">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
